...
Public Class Cloud_Engine
    ...
    Protected Overrides ReadOnly Property Icon As Bitmap
        Get
            Return Volvox.Common.My.Resources.Icon_Engine
        End Get
    End Property
    ...
    Public Overrides ReadOnly Property ComponentGuid As Guid
        Get
            Return GuidsRelease4.Comp_Engine
        End Get
    End Property
    ...
    Protected Overrides Sub SolveInstance(DA As IGH_DataAccess)
        ...
        Dim inputCloud As PointCloud = newGhCloud.Value 'To maintain scanner Position
        ...
        newGhCloud.Value = inputCloud 'To maintain scanner Position
