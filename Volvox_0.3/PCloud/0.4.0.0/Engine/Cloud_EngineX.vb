...
Public Class Cloud_EngineX
    ...
    Protected Overrides ReadOnly Property Icon As Bitmap
        Get
            Return Volvox.Common.My.Resources.Icon_EngineX
        End Get
    End Property
    ...
    Public Overrides ReadOnly Property ComponentGuid As Guid
        Get
            Return GuidsRelease4.Comp_EngineX
        End Get
    End Property
    ...
    Dim InputClouds As New DataTree(Of GH_Cloud) 'To maintain scanner Position (Of PointCloud)
            ...
            For i As Integer = 0 To Input.Branches.Count - 1 Step 1
                For j As Integer = 0 To Input.Branch(i).Count - 1 Step 1
                    ...
                    If thispc IsNot Nothing Then
                        InputClouds.Add(thispc.Duplicate, Input.Paths(i)) 'To maintain scanner Position - thispc.Value.Duplicate, Input.Paths(i))
                    Else
            ...
            SyncLock InputClouds
                ...
                For ipath As Integer = 0 To InputClouds.Paths.Count - 1 Step 1
                    For iitem As Integer = 0 To InputClouds.Branch(ipath).Count - 1 Step 1
                        ...
                        Dim cloud As PointCloud = InputClouds.Branch(ipath).Item(iitem).Value 'To maintain scanner Position -  NO .Value
                        ...
                        InputClouds.Branch(ipath).Item(iitem).Value = inputcloud 'To maintain scanner Position -  NO .Value
                        cloudthis += 1
