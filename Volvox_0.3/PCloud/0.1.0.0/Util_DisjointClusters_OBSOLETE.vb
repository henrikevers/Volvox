...
Public Class Util_DisjointClusters_OBSOLETE
    ...
    Public Overrides ReadOnly Property ComponentGuid As Guid
        Get
            Return GuidsRelease1.Comp_Disjoint
        End Get
    End Property
    ...
    Protected Overrides ReadOnly Property Icon As Bitmap
        Get
            Return Volvox.Common.My.Resources.Icon_Disjoint
        End Get
    End Property
    ...
    Function VoxelSplit(pc As PointCloud, vsize As Double) As Rhino.Geometry.PointCloud()
        ...
        For i As Integer = 0 To vx.Count - 1 Step 1
            Dim ni As New Interval(st, st + vx(i).Faces.Count - 1)
            st += vx(i).Faces.Count
            intl(i) = ni
        Next
