...
Public Class CC_XYZCommand
    ...
    Public Overrides ReadOnly Property ComponentGuid As Guid
        Get
            Return GuidsRelease2.CC_XYZCommand
        End Get
    End Property
    ...
    Protected Overrides ReadOnly Property Icon As Bitmap
        Get
            Return Volvox.Common.My.Resources.Icon_CommandXYZ
        End Get
    End Property
    ...
    Protected Overrides Sub SolveInstance(DA As IGH_DataAccess)
        ...
        If run Then
            ...
            If File.Exists(filepath) Then
                ...
                arg += "-SILENT -O "
                arg += filepath
                arg += " -NO_TIMESTAMP -C_EXPORT_FMT ASC -EXT xyz -AUTO_SAVE OFF -MERGE_CLOUDS "
    ...
    Sub RunThread(arg)
        ...
        Dim tmpPath = Directory.GetFiles(Path.GetDirectoryName(filepath), Path.GetFileNameWithoutExtension(filepath) & "_*.xyz").OrderByDescending(Function(f) New FileInfo(f).LastWriteTime).First()
        If File.Exists(tmpPath) Then
            outputPath = Path.Combine(Path.GetDirectoryName(filepath), outname & ".xyz")
