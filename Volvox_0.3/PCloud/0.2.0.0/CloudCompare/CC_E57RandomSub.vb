...
Public Class CC_E57RandomSub
    ...
    Public Overrides ReadOnly Property ComponentGuid As Guid
        Get
            Return GuidsRelease2.CC_E57RandomSub
        End Get
    End Property
    ...
    Protected Overrides ReadOnly Property Icon As Bitmap
        Get
            Return Volvox.Common.My.Resources.Icon_RandomCC
        End Get
    End Property
    ...
    Protected Overrides Sub SolveInstance(DA As IGH_DataAccess)
        ...
        If run Then
            ...
            If File.Exists(filepath) Then
                ...
                arg += "-SILENT -O "
                arg += filepath
                arg += " -NO_TIMESTAMP -C_EXPORT_FMT E57 -AUTO_SAVE OFF -SS RANDOM "
                arg += Str(amount)
