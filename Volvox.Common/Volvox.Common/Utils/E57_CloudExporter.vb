...
Public Class E57_CloudExporter
    ...
    Public spher As Boolean = False

    Public fpath As String = String.Empty
    Public fguid As String = String.Empty
    Public fmeta As String = String.Empty
    Public fpclo As New List(Of PointCloud)
    Public spose As New List(Of Plane)
    Public sguid As New List(Of String)
    Public sname As New List(Of String)
    Public sdesc As New List(Of String)
    Public svend As New List(Of String)
    Public smode As New List(Of String)
    Public sseri As New List(Of String)
    Public shard As New List(Of String)
    Public ssoft As New List(Of String)
    Public sfirm As New List(Of String)
    Public stemp As New List(Of Double)
    Public shumi As New List(Of Double)
    Public spres As New List(Of Double)
    Public sstim As New List(Of Date)
    Public setim As New List(Of Date)
    Public ssboo As New List(Of Boolean)
    Public seboo As New List(Of Boolean)
