...
Public Class InstallerWindow
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If MsgBox("If you already have a version older than 0.3 of Volvox installed, please delete manually the files from Grasshopper libraries." & vbCrLf & vbCrLf & "Please do it before installing this version of Volvox.", MsgBoxStyle.OkCancel, "Volvox installer") <> MsgBoxResult.Ok Then
            Me.Close()
        End If
    End Sub
    ...
    Private Sub InstallBut_Click(sender As Object, e As EventArgs) Handles InstallBut.Click
        ...
        If nlic.ShowDialog(Me) = DialogResult.OK Then
            ...
            If IsInstalled() Then
                Dim msgboxres As MsgBoxResult = MsgBox("Volvox is already installed. Do you want to uninstall this version ?", MsgBoxStyle.OkCancel, "Volvox installer")
    ...
    Function Install(FolderPath As String) As Boolean
        ...
        Try
            ...
            IO.File.WriteAllBytes(FolderPath & "\Volvox.Common.dll", My.Resources.Volvox_Common)
            IO.File.WriteAllBytes(FolderPath & "\Volvox_0.4.0.1.gha", My.Resources.Volvox_0_4_0_1)
            IO.File.WriteAllBytes(FolderPath & "\Volvox_0.4.0.2.gha", My.Resources.Volvox_0_4_0_2)
            ...
            IO.File.WriteAllBytes(FolderPath & "\KDTree.Core.dll", My.Resources.KDTree_Core)
            IO.File.WriteAllBytes(FolderPath & "\KDTree.Common.dll", My.Resources.KDTree_Common)
