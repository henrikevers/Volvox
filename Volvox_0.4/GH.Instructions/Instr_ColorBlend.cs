...
{
    public class Instr_ColorBlend : Instr_BaseReporting
    {
        #region - Instruction Initialization
        /// <summary>
        /// Initialize Instruction Input Variables
        /// </summary>
        private Color insV_Color { get; set; }
        private double insV_Pct { get; set; }
        ...
        public Instr_ColorBlend(Color color, double pct)
        {
            insV_Color = color;
            insV_Pct = pct;
        }
        ...
        public override IGH_Goo Duplicate()
        {
            ...
            Instr_ColorBlend ni = new Instr_ColorBlend(nC,nP);
            ni.GlobalCloud = null;
            ni.NewCloud = null;
            ni.PointCounter = 0;
