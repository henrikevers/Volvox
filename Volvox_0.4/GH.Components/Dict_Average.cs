...
{
    public class Dict_Average : GH_Component
    {
        /// <summary>
        ...
        /// </summary>
        public Dict_Average()
          : base("Average Data", "AveData", "Average of data set stored in a cloud.", "Volvox", "UserData")
        {
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Volvox.Common.My.Resources.Resources.Icon_AverageData_2;
        ...
        {
            get { return GUIDs.GuidsRelease4.Component.Dict_Average; }
        }
        ...
        {
            pManager.AddNumberParameter("Ave", "A", "User data average", GH_ParamAccess.item);
