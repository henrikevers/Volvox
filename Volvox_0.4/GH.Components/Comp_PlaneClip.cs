...
{
    public class Comp_PlaneClip : GH_Component, IGH_VariableParameterComponent
    {
        /// <summary>
        ...
        /// </summary>
        public Comp_PlaneClip()
          : base("Plane Clip", "PClip", 
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Common.My.Resources.Resources.Icon_PlaneClip;
            }
        }
        ...
        {
            get { return GUIDs.GuidsRelease4.Component.Comp_PlaneClip; }
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (!DA.GetData("Plane", ref cPlane)) return;
            ...
            if (isInstruction)
            {
                DA.SetData("Instr", new Instruction.Instr_PlaneClip(cPlane));
            }
            else
            ///If Component is set to StandAlone. 
            {
                ...
                ///Execute Instruction.
                Instruction.Instr_PlaneClip inst = new Instruction.Instr_PlaneClip(cPlane);
