...
{
    public class Comp_ColorBlend : GH_Component, IGH_VariableParameterComponent
    {
        /// <summary>
        ...
        /// </summary>
        public Comp_ColorBlend()
          : base("ColorBlend", "Blend", "Blend Cloud Colors with another color.", "Volvox", "Util")
        {
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Volvox.Common.My.Resources.Resources.Icon_ColorBlend;
        ...
        {
            get { return GUIDs.GuidsRelease4.Component.Comp_ColorBlend; }
        }
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddColourParameter("Colour", "C", "Color to blend with", GH_ParamAccess.item);
            pManager.AddNumberParameter("Pct", "%", "Percentage", GH_ParamAccess.item, 0.5);
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            Color col = new Color();
            double pct = 0.5;
            if (!DA.GetData(1, ref col)) return;
            if (!DA.GetData(2, ref pct)) return;
            ...
            {
                //this.Message = "";
                DA.SetData("Instr", new Instruction.Instr_ColorBlend(col, pct));
            }
            else
            ///If Component is set to StandAlone. 
            {
                ...
                ///Execute Instruction.
                Instruction.Instr_ColorBlend inst = new Instruction.Instr_ColorBlend(col, pct);
