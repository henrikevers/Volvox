...
{
    public class Comp_MeshRay : GH_Component, IGH_VariableParameterComponent
    {
        /// <summary>
        ...
        /// </summary>
        public Comp_MeshRay()
          : base("Mesh Ray", "MRay", "Compute distance to a mesh in a certain direction.", "Volvox", "UserData")
        {
        ...
        {
            get { return GUIDs.GuidsRelease5.Component.Comp_MeshRay; }
        }
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddVectorParameter("Vector", "V", "Direction of Ray to calculate distance from.", GH_ParamAccess.item);
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (!DA.GetData("Vector", ref Vector)) return;
